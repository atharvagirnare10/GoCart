...
function HomeContent() {
  ...
  // ✅ DYNAMIC SPLIT: Backend jitne bhi items de, unhe exactly aadha-aadha baant do
  // Isse dono banners ke paas humesha enough items rahenge expand (View All) karne ke liye.
      ...
      <div className="relative z-10 w-full">
        {!searchQuery && (
          <div className="max-w-[1500px] mx-auto px-4 w-full pt-28">
            ...
            {/* ✅ BANNERS WITH NEW DYNAMIC ARRAY DATA */}
            {showBanners && displayTopDeals.length > 0 && (
              <div className="mb-16">
                <HorizontalScrollRow 
